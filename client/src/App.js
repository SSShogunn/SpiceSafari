...
import Favourite from "./components/CRUD_PAGES/Favourite";
import EditRecipes from "./components/CRUD_PAGES/EditRecipes";
import ViewRecipe from "./components/CRUD_PAGES/ViewFavouriteRecipe";
    ...
    <>
      <div>
        ...
        <Routes>
          ...
          <Route path="/favourite/:id" element={<ViewRecipe />} />
        </Routes>
      </div>
      <Footer />
